...
const contents = [
  {
    title: "RubiSlices",
    desc: "RubiSlices is a script that generates TikTok and Youtube Shorts using Reddit's content. Developed with Google's text to speech engine and HuggingFace LLM pipeline for text summarization and censorship.",
    learningAreas:
  ...
  },
  {
    ...
    learningAreas: "React, Go, mySQL, user surveys, Github Actions for CI/CD",
  ...
  },
  {
    ...
    learningAreas: "OpenAI API, JavaScript, building a Chrome Extension",
  ...
  },
  {
    ...
    desc: "A place where I blog about my coding experiences through university, internships, workshops and projects. With this, I hope to share what I've learnt with the rest of the world. This is actually the first website I built!",
    learningAreas: "HTML, JavaScript, CSS",
  ...
  {
    title: "Noisy Bird",
    desc: "A personal twist on Flappy Bird, where the iconic Singaporean 'Ooo-O!' bird cries are heard everytime you tap on the bird to make it fly.",
    learningAreas: "Pygame, game physics and collision detection",
  ...
  {
    title: "GuestBook",
    desc: "GuestBook is a hotel management application that aims to revolutionise the small hotel industry by helping hotel managers efficiently manage their guests' data.",
    learningAreas:
      "Java, JavaFX for frontend, JUnit for testing, drawing UML diagrams",
    githubLink: "https://github.com/bryanhce/striker",
    demoLink:
  ...
  },
  {
    ...
    learningAreas:
      "Next.js, Typescript, TailwindCSS, Chakra, fun packages like react-framer and react typewriter",
